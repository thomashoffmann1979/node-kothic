...
Geom.prototype.transformPoint = function (point, ws, hs) {
  return [ws * point[0], hs * point[1]];
}

Geom.prototype.transformPoints = function (points, ws, hs) {
...
Geom.prototype.getReprPoint = function(feature){
var point, len;
  ...
  switch (feature.type){
    ...
    case 'Polygon':
      ...
      break;
    case 'LineString':
      len = this.getPolyLength(feature.coordinates);
      point = this.getAngleAndCoordsAtLength(feature.coordinates, len / 2, 0);
...
Geom.prototype.getPolyLength = function (points) {
...
Geom.prototype.getAngleAndCoordsAtLength = function (points, dist, width) {
  var pointsLen = points.length,
  dx, dy, x, y,
  i, c, pc,
  len = 0,
